	...
	testInit()
	{
		var base_loop_circle_up = new Base('sys','loop'); //设置循环函数
			...
			var task_loop0 = new Base_task(base_loop_circle_up) //Base_task 需要指定父节点
				task_loop0.add(new Base("sys","move_up"));
				task_loop0.add(new Base("sys","move_left"));
				task_loop0.add(new Base("sys","move_up"));
				task_loop0.add(new Base("sys","move_right"));
		base_loop_circle_up.set_task(task_loop0);//向父节点添加执行列表
		...
		var base_loop_r = new Base('sys','loop'); //设置循环函数
			...
			var task_loop1 = new Base_task(base_loop_r) //Base_task 需要指定父节点
				task_loop1.add(new Base("sys","move_right"));
		base_loop_r.set_task( task_loop1);//向父节点添加执行列表
		...
		var base_loop_circle_down = new Base('sys','loop'); //设置循环函数
			...
			var task_loop2 = new Base_task(base_loop_circle_down) //Base_task 需要指定父节点
				task_loop2.add(new Base("sys","move_down"));
				task_loop2.add(new Base("sys","move_right"));
				task_loop2.add(new Base("sys","move_down"));
				task_loop2.add(new Base("sys","move_left"));
		base_loop_circle_down.set_task( task_loop2);//向父节点添加执行列表
		...
		var base_loop_circle_right = new Base('sys','loop'); //设置循环函数
			...
			var task_loop3 = new Base_task(base_loop_circle_right) //Base_task 需要指定父节点
				task_loop3.add(new Base("sys","move_down"));
				task_loop3.add(new Base("sys","move_left"));
				task_loop3.add(new Base("sys","move_up"));
				task_loop3.add(new Base("sys","move_left"));
		base_loop_circle_right.set_task(task_loop3);//向父节点添加执行列表
		...
		var base_loop_d = new Base('sys','loop'); //设置循环函数
			...
			var task_loop4 = new Base_task(base_loop_d) //Base_task 需要指定父节点
				task_loop4.add(new Base("sys","move_down"));
		base_loop_d.set_task(task_loop4);//向父节点添加执行列表
		...
		var base_loop_l7 = new Base('sys','loop'); //设置循环函数
			...
			var task_loop5 = new Base_task(base_loop_l7) //Base_task 需要指定父节点
				task_loop5.add(new Base("sys","move_right"));
		base_loop_l7.set_task(task_loop5);//向父节点添加执行列表
		...
		var base_loop_circle = new Base('sys','loop'); //设置循环函数
			...
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_up"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_down"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_left"));
			task_loop6.add(new Base("sys","move_down"));
			...
			task_loop6.add(new Base("sys","move_down"));
			task_loop6.add(new Base("sys","move_down"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
			task_loop6.add(new Base("sys","move_right"));
		base_loop_circle.set_task(task_loop6);//向父节点添加执行列表
